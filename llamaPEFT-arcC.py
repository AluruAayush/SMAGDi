# Llama-PEFT Baseline on Arc-C using CoT 
...
def format_strategyqa(example):
    ...
    system_prompt = (
        ...
        "Possible Answers: " + example["choices"] + "\n" # fixed 
        "Instructions:\n"
        "Instructions:\n"
        ...
        "5. State your final answer as either \"A\" or \"B\" or \"C\" or \"D\" corresponding to the answer choice you agree with\n"
        "Analysis and Answer:"
    )
...
def compute_metrics(eval_pred):
    ...
    def parse_final_answer(generated_text: str) -> str | None:
        ...
        patterns = [
            r'ANSWER:\s*(a|b|c|d)',
            r'CONCLUSION:\s*(a|b|c|d)',
            r'Answer:\s*(a|b|c|d)',
            r'Final answer:\s*(a|b|c|d)',
            r'\b(a|b|c|d)\s*$',  # Last True/False in text
            r'\b(a|b|c|d)\b'     # Any True/False
        ]
